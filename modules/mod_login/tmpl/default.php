			...
			<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-prepend">
						<span class="add-on">
							<span class="icon-user hasTooltip" title="Nombre usuario"></span>
							<label for="modlgn-username" class="element-invisible">Nombre usuario</label>
						</span>
				...
				<?php else: ?>
					<label for="modlgn-username">Nombre usuario</label>
					<input id="modlgn-username" type="text" name="username" class="input-small" tabindex="0" size="18" placeholder="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>" />
				<?php endif; ?>
			</div>
		</div>

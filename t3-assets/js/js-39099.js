...
/*===============================
http://localhost:8080/luismoreno3//modules/mod_jafacebooklikebox/asset/elements/japanel/depend.js
================================================================================*/;
...
depends[elm][name].push(info.val);this.register(name,elm);},this);},start:function(){$(document.adminForm).getElements('h4.block-head').each(function(el){this.closest(el,'li, div.control-group').addClass('segment')},this);$(document.adminForm).getElements('.hideanchor').each(function(el){this.closest(el,'li, div.control-group').addClass('hide');},this);this.update();},update:function(){Object.each(this.controls,function(ctrls,ctrl){this.elmsFrom(ctrl).fireEvent('change');},this);},enable:function(el){el._disabled=false;this.closest(el,'.adminformlist > li, div.control-group').setStyle('display','block');},disable:function(el){el._disabled=true;this.closest(el,'.adminformlist > li, div.control-group').setStyle('display','none');},elmsFrom:function(name){var el=document.adminForm[name];if(!el){el=document.adminForm[name+'[]'];}
...
/*===============================
http://localhost:8080/luismoreno3//modules/mod_jafacebooklikebox/asset/elements/japanel/script30.js
================================================================================*/;
(function($)

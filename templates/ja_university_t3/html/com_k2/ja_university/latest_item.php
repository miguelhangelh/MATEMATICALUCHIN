...
<div class="latestItemView">
  ...
  <div class="latestItemBody">
	  ...
	  <?php if($this->item->params->get('latestItemIntroText') || $this->item->params->get('latestItemImage') && !empty($this->item->image)): ?>
	  <!-- Item introtext -->
	  <div class="latestItemIntroText">
			<?php if($this->item->params->get('latestItemImage') && !empty($this->item->image)): ?>
			<!-- Item Image -->
			<div class="latestItemImageBlock" style="width:<?php echo $this->item->imageWidth; ?>px;" >
